...
本模块现已提供现代化的 Jetpack Compose 用户界面，大幅提升了操作便捷性和用户体验。

### 🎨 现代化界面功能

- **首页** - 提供皮肤设置和主题中心的便捷入口
- **皮肤设置** - 完整的会员等级选择、皮肤导入导出功能
- **主题中心** - 主题管理、导入、导出和切换功能

所有操作均可通过直观的界面完成，无需手动操作文件。

### 📦 资源包下载

SD资源包手动下载：[SD卡资源文件](https://github.com/LiYiCha/AlipayHighHeadsomeRichAndroid/blob/master/SD%E5%8D%A1%E8%B5%84%E6%BA%90%E6%96%87%E4%BB%B6%E5%8C%85/SD%E8%B5%84%E6%BA%90%E6%96%87%E4%BB%B6.zip)
...
1. **导出主题** - 从支付宝导出当前使用的主题到 SD 卡
2. **导入主题** - 从 ZIP 文件或目录导入自定义主题
3. **切换主题** - 选择并应用想要的主题
4. **主题预览** - 查看主题预览图

主题存储位置：`/storage/emulated/0/Android/media/com.eg.android.AlipayGphone/000_HOHO_THEME_CENTER/themes`
...
- **Hook 框架**：Xposed API
- **目标应用**：支付宝（com.eg.android.AlipayGphone）
